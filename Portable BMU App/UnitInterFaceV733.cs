...
namespace Portable_BMU_App
{
    ...
    /// </summary>
    public static class UnitInterFaceV733
    {

        // ----------------------------- Scanner Type -------------------------//

        public enum ChooseScannerType
        {
            Clarius = 0,
            Clarius_HD = 1,
        }
        ...
        [DllImport("cast.dll", EntryPoint = "clariusInitCast")]
        public static extern int clariusInitCast(int argc, string[] argv, string dir, ClariusNewProcessedImageFnCallBack newImage, ClariusNewRawImageCallback newRawImage,
        ...
        [DllImport("cast.dll", EntryPoint = "clariusConnect")]
        public static extern int clariusConnect(string ipAddress, uint port, ClariusReturnCallback fn);

        [DllImport("cast.dll", EntryPoint = "clariusDisconnect")]
        public static extern int clariusDisconnect(ClariusReturnCallback fn);

        [DllImport("cast.dll", EntryPoint = "clariusDestroyCast")]
        public static extern int clariusDestroyCast();


        [DllImport("cast.dll", EntryPoint = "clariusUserFunction")]
        public static extern int clariusUserFunction(int userFn, double val, ClariusReturnCallback fn);
